...
const ROUTE_MAP_DATA = {
  title: "Shimla 2N/3D from Chandigarh",
  stops: [
    ...
    { lat: 31.0780, lng: 77.1130, name: "Tara Devi Temple", desc: "Hilltop temple with panoramic views of Shimla and Kasauli.", type: "temple" },
...
const PAGE_DETAILS = {
  ...
  inclusions: [
    ...
    "Vegetarian breakfast and dinner (Note: only vegetarian meals served in Sunrise Villa Shimla)",
...
export default function Shimla2N3DChandigarh() {

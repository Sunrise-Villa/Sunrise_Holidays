...
const destKufriImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/manali_4.webp";
import RouteMap from '../../../components/RouteMap';

const ROUTE_MAP_DATA = {
  title: "Shimla-Manali 5N/6D from Delhi",
  stops: [
    ...
    { lat: 31.0989, lng: 77.2640, name: "Kufri", desc: "Snow slopes, horse rides.", type: "adventure" },
    { lat: 31.1048, lng: 77.1734, name: "The Ridge & Mall Road", desc: "Evening walk on Shimla promenade.", type: "market" },
    ...
    { lat: 32.2611, lng: 77.1810, name: "Vashisht Hot Springs", desc: "Hot sulphur baths.", type: "springs" },
    { lat: 32.3722, lng: 77.2466, name: "Rohtang Pass", desc: "3978m glaciers. Sledge rides.", type: "mountain" },
    { lat: 32.3154, lng: 77.1546, name: "Solang Valley", desc: "Paragliding and Nehru Kund.", type: "adventure" },
...
const PAGE_DETAILS = {
  ...
  itinerary: [
    ...
    {
      day: 5,
      title: "Manali Snow-point / Rohtang Pass Glaciers",
...
export default function ShimlaManali5N6DDelhi() {

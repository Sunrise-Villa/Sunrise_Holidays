...
const ROUTE_MAP_DATA = {
  title: "Shimla-Manali 4N/5D from Delhi",
  stops: [
    { lat: 28.6421, lng: 77.2195, name: "Delhi Pickup", desc: "Pickup from New Delhi railway station or airport.", type: "pickup" },
    { lat: 30.7987, lng: 76.9182, name: "Pinjore Gardens", desc: "Mughal terraced garden on the way to Shimla.", type: "nature" },
    ...
    { lat: 31.0989, lng: 77.2640, name: "Kufri", desc: "Snow slopes, Wild Flower Hall panorama.", type: "adventure" },
    { lat: 31.1048, lng: 77.1734, name: "The Ridge & Mall Road", desc: "Shimla's iconic promenade.", type: "market" },
    { lat: 31.7089, lng: 76.9320, name: "Mandi", desc: "En route Shimla to Manali.", type: "town" },
    { lat: 31.9579, lng: 77.1095, name: "Kullu", desc: "Beas river and Kullu shawl market.", type: "market" },
    { lat: 32.2432, lng: 77.1543, name: "Hadimba Devi Temple", desc: "Ancient cedar forest temple.", type: "temple" },
    { lat: 32.3722, lng: 77.2466, name: "Rohtang Pass", desc: "3978m. Snow glaciers and sledge rides.", type: "mountain" },
...
export default function ShimlaManali4N5DDelhi() {

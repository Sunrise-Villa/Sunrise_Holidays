...
const destRohtangImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/manali_6.webp";
import RouteMap from '../../../components/RouteMap';

const ROUTE_MAP_DATA = {
  title: "Manali 4N/5D from Delhi",
  stops: [
    { lat: 28.6421, lng: 77.2195, name: "Delhi Pickup", desc: "Pickup from New Delhi railway station or airport.", type: "pickup" },
    { lat: 30.3782, lng: 76.7767, name: "Ambala", desc: "Highway junction city on NH-44.", type: "town" },
    ...
    { lat: 32.2611, lng: 77.1810, name: "Vashisht Hot Springs", desc: "Sulphur spring baths near Vashisht village.", type: "springs" },
    { lat: 32.3722, lng: 77.2466, name: "Rohtang Pass", desc: "3978m glaciers. Sledge rides and snow walks.", type: "mountain" },
    { lat: 32.3154, lng: 77.1546, name: "Solang Valley", desc: "Paragliding, ski slopes, and snow activities.", type: "adventure" },
    { lat: 31.9970, lng: 77.3479, name: "Manikaran Hot Springs", desc: "Sacred hot springs and Gurudwara in Parvati Valley.", type: "springs" },
  ...
  itinerary: [
    {
      ...
      desc: "Pickup from Delhi Railway station / airport and drive to Manali. It will take 13 to 15 hours and the distance is 560 Kms. The cab will pass through Panipat, Kurukshetra, Ambala, Chandigarh, Bilaspur, Sundernagar, Mandi and Kullu on the way to Manali. Check in and overnight stay in Manali."
    },
    {
      day: 2,
...
export default function Manali4N5DDelhi() {

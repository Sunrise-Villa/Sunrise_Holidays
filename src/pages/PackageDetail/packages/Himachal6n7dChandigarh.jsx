...
const destKufriImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Himachal_3.jpg";
...
const ROUTE_MAP_DATA = {
  ...
  stops: [
    ...
    { lat: 30.7987, lng: 76.9182, name: "Pinjore Gardens", desc: "Mughal-style heritage terraced gardens", type: "nature" },
    { lat: 30.8372, lng: 76.9618, name: "Timber Trail, Parwanoo", desc: "Scenic ropeway point", type: "adventure" },
    { lat: 31.1186, lng: 77.1200, name: "Sunrise Villa, Shoghi", desc: "Stay at Sunrise Villa property in Shoghi", type: "stay" },
    { lat: 31.0830, lng: 77.1350, name: "Sankat Mochan Temple", desc: "Revered temple near Shimla", type: "temple" },
    { lat: 31.0989, lng: 77.2640, name: "Kufri", desc: "Snow slopes & nature park", type: "adventure" },
    { lat: 31.0874, lng: 77.3090, name: "Fagu", desc: "Apple orchard viewpoints", type: "nature" },
    { lat: 31.6700, lng: 77.0600, name: "Pandoh Dam", desc: "Dam on Beas River", type: "nature" },
    { lat: 31.9578, lng: 77.1095, name: "Kullu Valley", desc: "Handloom shawls shopping hub", type: "market" },
    { lat: 32.2470, lng: 77.1820, name: "Hadimba Temple", desc: "Ancient wood temple in Manali deodar woods", type: "temple" },
    { lat: 32.3700, lng: 77.2400, name: "Rohtang Pass", desc: "High altitude snowy pass & glaciers", type: "adventure" },
    { lat: 32.3160, lng: 77.1780, name: "Solang Valley", desc: "Adventure activity slopes", type: "adventure" },
    { lat: 32.2190, lng: 76.3230, name: "Dharamshala & McLeodGanj", desc: "Residence of Dalai Lama & Tibetan culture", type: "landmark" },
    { lat: 32.5387, lng: 75.9710, name: "Dalhousie", desc: "Colonial town outer Dhauladhar range", type: "town" },
    { lat: 32.5540, lng: 76.0620, name: "Khajjiar Lake", desc: "Mini Switzerland saucer plateau", type: "nature" },
    { lat: 30.6680, lng: 76.8070, name: "Chandigarh Drop", desc: "End of package dropping", type: "drop" }
  ]
};
...
export default function Himachal6n7dChandigarh() {

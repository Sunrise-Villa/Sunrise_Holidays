...
const destKufriImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Himachal_4.webp";
const destShimlaImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Shimla_2.webp";
const destManaliImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/manali_2.webp";
const destRohtangImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Himachal_2.webp";
...
const ROUTE_MAP_DATA = {
  ...
  stops: [
    ...
    { lat: 30.7987, lng: 76.9182, name: "Pinjore Gardens", desc: "Optional gardens break", type: "nature" },
    ...
    { lat: 31.6700, lng: 77.0600, name: "Pandoh & Kullu", desc: "Beas valley drive", type: "nature" },
    { lat: 32.2470, lng: 77.1820, name: "Hadimba Temple", desc: "Wood temple", type: "temple" },
    { lat: 32.3700, lng: 77.2400, name: "Rohtang Pass & Solang", desc: "Glacier peak views", type: "adventure" },
...
const PAGE_DETAILS = {
  ...
  itinerary: [
    ...
    {
      day: 7,
      title: "Khajjiar Sightseeing & return to Delhi",
...
export default function Himachal6n7dDelhi() {

...
const destRohtangImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Shimla_5.webp";
import RouteMap from '../../../components/RouteMap';

const ROUTE_MAP_DATA = {
  title: "Shimla-Manali 4N/5D from Chandigarh",
  stops: [
    ...
    { lat: 30.7987, lng: 76.9182, name: "Pinjore Gardens", desc: "Mughal terraced garden. Optional en-route stop.", type: "nature" },
    ...
    { lat: 31.0989, lng: 77.2640, name: "Kufri", desc: "Snow slopes and Wild Flower Hall views.", type: "adventure" },
    { lat: 31.1048, lng: 77.1734, name: "The Ridge & Mall Road", desc: "Shimla's iconic promenade. Evening walk.", type: "market" },
    { lat: 31.7089, lng: 76.9320, name: "Mandi", desc: "En route Shimla to Manali. Gateway town.", type: "town" },
    ...
    { lat: 32.3722, lng: 77.2466, name: "Rohtang Pass", desc: "Glaciers and sledge rides at 3978m.", type: "mountain" },
    { lat: 32.3154, lng: 77.1546, name: "Solang Valley", desc: "Paragliding and cable car on the way back.", type: "adventure" },
...
export default function ShimlaManali4N5DChandigarh() {

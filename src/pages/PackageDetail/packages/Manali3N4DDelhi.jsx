...
const destRohtangImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/manali_4.webp";
import RouteMap from '../../../components/RouteMap';

const ROUTE_MAP_DATA = {
  title: "Manali 3N/4D from Delhi",
  stops: [
    ...
    { lat: 32.2432, lng: 77.1543, name: "Hadimba Devi Temple", desc: "450-year-old cedarwood temple in deodar forest.", type: "temple" },
    { lat: 32.2611, lng: 77.1810, name: "Vashisht Hot Springs", desc: "Ancient hot sulphur springs and village.", type: "springs" },
    { lat: 32.3722, lng: 77.2466, name: "Rohtang Pass", desc: "3978m glacier. Sledge rides and snow walks.", type: "mountain" },
    { lat: 32.3154, lng: 77.1546, name: "Solang Valley", desc: "Snow slopes, zip-line, and sky views.", type: "adventure" },
...
const PAGE_DETAILS = {
  ...
  overview: "Escape the heat of Delhi for the glacial peaks of Manali. This 4-day tour includes Delhi pickup, comfortable transport, local temple tours, and a full-day excursion to Rohtang Pass and Solang Valley.",
...
export default function Manali3N4DDelhi() {

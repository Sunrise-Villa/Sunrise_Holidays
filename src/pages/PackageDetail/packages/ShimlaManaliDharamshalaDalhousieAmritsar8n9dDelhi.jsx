...
const destKufriImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Himachal_2.webp";
const destShimlaImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Shimla_6.webp";
const destManaliImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/manali_6.webp";
const destRohtangImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Himachal_4.webp";
...
const ROUTE_MAP_DATA = {
  ...
  stops: [
    ...
    { lat: 31.0989, lng: 77.2640, name: "Kufri", desc: "Snow slopes and park", type: "adventure" },
    { lat: 31.6700, lng: 77.0600, name: "Pandoh & Kullu", desc: "Highways scenic transit stops", type: "nature" },
    { lat: 32.2470, lng: 77.1820, name: "Hadimba & Rohtang", desc: "Temples and high glaciers", type: "adventure" },
    { lat: 32.2190, lng: 76.3230, name: "Dharamshala", desc: "Dalai Lama spiritual home", type: "landmark" },
    { lat: 32.5387, lng: 75.9710, name: "Dalhousie", desc: "Forest ridge town", type: "town" },
    { lat: 32.5540, lng: 76.0620, name: "Khajjiar", desc: "Switzerland of India Meadows", type: "nature" },
    { lat: 31.6047, lng: 74.5739, name: "Wagah Border, Amritsar", desc: "Retreat ceremony", type: "landmark" },
    { lat: 31.6200, lng: 74.8765, name: "Golden Temple, Amritsar", desc: "Harmandir Sahib shrine", type: "temple" },
...
const PAGE_DETAILS = {
  ...
  itinerary: [
    ...
    {
      day: 8,
      title: "Dalhousie - Amritsar Drive",
    ...
    {
      day: 9,
      title: "Amritsar Sightseeing & Delhi Drop-off",
      desc: "Early Morning visit to Golden Temple  and  Jalianwala bagh. After that Drive to Delhi and  the cab will drop you  New Delhi Railway Station / bus station / Airport.  Amritsar Delhi travel time is 9  hours (460 Kilometers)"
    }
  ],
...
export default function ShimlaManaliDharamshalaDalhousieAmritsar8n9dDelhi() {

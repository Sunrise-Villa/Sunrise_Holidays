...
const destKufriImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Himachal_1.jpg";
const destShimlaImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Shimla_5.jpg";
const destManaliImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/manali_4.jpg";
...
const ROUTE_MAP_DATA = {
  ...
  stops: [
    ...
    { lat: 31.1186, lng: 77.1200, name: "Sunrise Villa, Shoghi", desc: "Boutique property in Shimla", type: "stay" },
    { lat: 31.0989, lng: 77.2640, name: "Kufri", desc: "Snow activity viewpoint", type: "adventure" },
    { lat: 31.6700, lng: 77.0600, name: "Pandoh & Kullu", desc: "Riverside stops", type: "nature" },
    { lat: 32.3700, lng: 77.2400, name: "Rohtang Pass & Solang", desc: "Glacial views", type: "adventure" },
    { lat: 32.2190, lng: 76.3230, name: "Dharamshala", desc: "Dalai Lama residence", type: "landmark" },
    { lat: 32.5387, lng: 75.9710, name: "Dalhousie", desc: "Pine forest walks", type: "town" },
    { lat: 32.5540, lng: 76.0620, name: "Khajjiar", desc: "Switzerland of India meadow", type: "nature" },
    { lat: 31.6047, lng: 74.5739, name: "Wagah Border, Amritsar", desc: "India-Pakistan border ceremony", type: "landmark" },
    { lat: 31.6200, lng: 74.8765, name: "Golden Temple, Amritsar", desc: "Sikh holy site", type: "temple" },
...
const PAGE_DETAILS = {
  ...
  itinerary: [
    ...
    {
      day: 7,
      title: "Excursion to Khajjiar Saucer Meadows",
    ...
    {
      day: 8,
      title: "Dalhousie - Amritsar Drive & Wagah Border",
      desc: "Checkout from Hotel in the morning and drive to Amritsar. Travel time 4 hours (190 Kilometers). Visit The India Pakistan Wagha Border in the evening. Night stay at Hotel in Amritsar."
    },
    {
      day: 9,
      title: "Amritsar Sightseeing & Chandigarh Drop-off",
      desc: "Local Sight seeing of the Amritsar Which includes sightseeing of Golden Temple  and  Jalianwala bagh. In evening the cab will drop you Chandigarh Railway Station / bus station / Airport.  Amritsar Chandigarh travel time is 5 hours (230 Kilometers)"
    }
  ],
...
export default function ShimlaManaliDharamshalaDalhousieAmritsar8n9dChandigarh() {

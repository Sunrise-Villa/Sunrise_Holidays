...
const destManaliImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/manali_3.jpg";
import RouteMap from '../../../components/RouteMap';

const ROUTE_MAP_DATA = {
  title: "Manali 4N/5D from Chandigarh",
  stops: [
    { lat: 30.6680, lng: 76.8070, name: "Chandigarh Pickup", desc: "Pickup from Chandigarh railway station or airport.", type: "pickup" },
    { lat: 31.6630, lng: 77.0470, name: "Pandoh Dam", desc: "Scenic dam on the Beas river. Photo stop.", type: "dam" },
    { lat: 31.7089, lng: 76.9320, name: "Mandi", desc: "Gateway to Kullu Valley. Ancient temple town.", type: "heritage" },
    { lat: 31.9579, lng: 77.1095, name: "Kullu", desc: "Kullu Dussehra fame. Shawl markets. Beas river.", type: "market" },
    ...
    { lat: 32.2396, lng: 77.1887, name: "Mall Road, Manali", desc: "Shopping for local handicrafts and cuisine.", type: "market" },
    { lat: 32.3722, lng: 77.2466, name: "Rohtang Pass", desc: "3978m glaciers. Sledge rides and snow walks.", type: "mountain" },
    { lat: 32.3154, lng: 77.1546, name: "Solang Valley", desc: "Paragliding, ski slopes, and sky views.", type: "adventure" },
...
const PAGE_DETAILS = {
  ...
  inclusions: [
    ...
    "Breakfast and dinner included (vegetarian meals served in Sunrise Villa Shimla)",
...
export default function Manali4N5DChandigarh() {

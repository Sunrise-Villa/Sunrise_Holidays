...
const destManaliImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Himachal_1.webp";
import RouteMap from '../../../components/RouteMap';

const ROUTE_MAP_DATA = {
  title: "Shimla-Manali 6N/7D from Chandigarh",
  stops: [
    ...
    { lat: 31.1048, lng: 77.1734, name: "The Ridge & Mall Road", desc: "Heritage walk and Shimla promenade.", type: "market" },
    { lat: 31.0989, lng: 77.2640, name: "Kufri", desc: "Snow slopes and Himalayan National Park.", type: "adventure" },
    { lat: 31.1500, lng: 77.1200, name: "Naldehra", desc: "Golf course and jungle walks.", type: "nature" },
    { lat: 31.7089, lng: 76.9320, name: "Mandi", desc: "En route to Manali via Pandoh Dam.", type: "town" },
  ...
  itinerary: [
    {
      ...
      desc: "Pickup from Chandigarh Airport / Railway Station / Bus Stand by exclusive vehicle. Drive to Shimla (117 km, 3 hours) via Kalka, Parwanoo, Solan. Stop at Pinjore Garden. Check in and overnight stay in Hotel."
    },
    {
      day: 2,
...
export default function ShimlaManali6N7DChandigarh() {

...
const destKufriImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/manali_2.webp";
import RouteMap from '../../../components/RouteMap';

const ROUTE_MAP_DATA = {
  title: "Shimla-Manali 5N/6D from Chandigarh",
  stops: [
    ...
    { lat: 31.1048, lng: 77.1734, name: "The Ridge & Mall Road", desc: "Shimla promenade with heritage churches.", type: "market" },
    { lat: 31.0989, lng: 77.2640, name: "Kufri", desc: "Snow slopes, Himalayan National Park.", type: "adventure" },
    { lat: 31.1500, lng: 77.1200, name: "Naldehra", desc: "18-hole golf course in cedar forest.", type: "nature" },
    { lat: 31.7089, lng: 76.9320, name: "Mandi", desc: "En route Shimla to Manali.", type: "town" },
    { lat: 31.9579, lng: 77.1095, name: "Kullu", desc: "Beas river and shawl market.", type: "market" },
    { lat: 32.2432, lng: 77.1543, name: "Hadimba Devi Temple", desc: "Ancient cedar forest temple.", type: "temple" },
    { lat: 32.3722, lng: 77.2466, name: "Rohtang Pass", desc: "3978m glaciers. Sledge rides.", type: "mountain" },
    { lat: 32.3154, lng: 77.1546, name: "Solang Valley", desc: "Paragliding and cable car views.", type: "adventure" },
...
const PAGE_DETAILS = {
  ...
  itinerary: [
    ...
    {
      day: 2,
      title: "Shimla Local Sightseeing & Heritage walk",
...
export default function ShimlaManali5N6DChandigarh() {

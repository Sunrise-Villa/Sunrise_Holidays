...
const destRohtangImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Himachal_3.jpg";
import RouteMap from '../../../components/RouteMap';

const ROUTE_MAP_DATA = {
  title: "Shimla-Manali 7N/8D from Chandigarh",
  stops: [
    { lat: 30.6680, lng: 76.8070, name: "Chandigarh Pickup", desc: "Pickup from Chandigarh railway station or airport.", type: "pickup" },
    { lat: 30.7987, lng: 76.9182, name: "Pinjore Gardens", desc: "Mughal terraced garden en route.", type: "nature" },
    { lat: 31.1186, lng: 77.1200, name: "Sunrise Villa, Shoghi", desc: "Stay at Sunrise Villa property in Shoghi.", type: "stay" },
    { lat: 31.0780, lng: 77.1130, name: "Tara Devi Temple", desc: "Hilltop temple with panoramic views.", type: "temple" },
    { lat: 31.0830, lng: 77.1350, name: "Sankat Mochan Temple", desc: "Revered Hanuman temple near Shimla.", type: "temple" },
    { lat: 31.1048, lng: 77.1734, name: "The Ridge & Mall Road", desc: "Heritage promenade.", type: "market" },
    { lat: 31.0989, lng: 77.2640, name: "Kufri", desc: "Snow slopes and Himalayan park.", type: "adventure" },
    { lat: 31.1500, lng: 77.1200, name: "Naldehra", desc: "18-hole golf course in cedar forest.", type: "nature" },
    { lat: 31.7089, lng: 76.9320, name: "Mandi", desc: "En route to Manali.", type: "town" },
    { lat: 31.9579, lng: 77.1095, name: "Kullu", desc: "Beas river and shawl markets.", type: "market" },
    { lat: 32.2432, lng: 77.1543, name: "Hadimba Devi Temple", desc: "Ancient cedarwood temple.", type: "temple" },
    { lat: 32.2611, lng: 77.1810, name: "Vashisht Hot Springs", desc: "Sulphur spring baths.", type: "springs" },
    { lat: 32.3722, lng: 77.2466, name: "Rohtang Pass", desc: "3978m glaciers and sledge rides.", type: "mountain" },
    { lat: 31.9970, lng: 77.3479, name: "Manikaran Hot Springs", desc: "Sacred Parvati Valley hot springs and gurudwara.", type: "springs" },
...
const PAGE_DETAILS = {
  ...
  itinerary: [
    {
      ...
      desc: "Pickup from Chandigarh Airport / Railway Station / Bus Stand by exclusive vehicle. Drive to Shimla (117 km, 3 hours) via Pinjore Garden. Check in and overnight stay in Hotel."
    },
    {
      day: 2,
      title: "Shimla Local Sightseeing",
      desc: "After Breakfast, visit to the years old Tara Devi Temple, Sankat Mochan Temple, visit Indian Institute of advance Studies, Army Museum, Jakhoo temple. In the evening explore Shimla city on foot. You can see prime places of Shimla like, Lakkar Bazaar, Ridge, Church, Mall road, Scandal Point, Kali Bari temple etc. Ideal time for shopping and eating out at restaurants on the mall road."
    },
    {
      day: 3,
    ...
    },
    {
      ...
      desc: "Morning proceed to Visit the 450 years old Hadimba Devi Temple, Tibetan center & monastery, Club House, Vanvihar, Mall Road Manali and Vashisht village hot springs. Night stay in Manali."
    },
    {
      day: 6,
    ...
    {
      day: 7,
      title: "Manali - Manikaran - Kullu stay",
  ...
  exclusions: [
    "Activity charges, sledge rides, and local guides",
    "Lunches, laundry, and personal shopping"
  ]
};

export default function ShimlaManali7N8DChandigarh() {

...
const destKufriImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Shimla_4.webp";
import RouteMap from '../../../components/RouteMap';

const ROUTE_MAP_DATA = {
  title: "Shimla 3N/4D from Delhi",
  stops: [
    ...
    { lat: 30.7987, lng: 76.9182, name: "Pinjore Gardens", desc: "Mughal-style heritage terraced garden.", type: "nature" },
    ...
    { lat: 31.1125, lng: 77.1775, name: "Jakhoo Temple", desc: "Famous Hanuman temple atop Jakhu Hill.", type: "temple" },
...
export default function Shimla3N4DDelhi() {

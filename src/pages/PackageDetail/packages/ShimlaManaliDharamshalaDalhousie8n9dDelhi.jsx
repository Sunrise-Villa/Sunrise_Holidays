...
const destKufriImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/manali_1.jpg";
const destShimlaImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/manali_2.jpg";
const destManaliImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/manali_3.jpg";
const destRohtangImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Himachal_2.jpg";
...
const ROUTE_MAP_DATA = {
  ...
  stops: [
    ...
    { lat: 31.6700, lng: 77.0600, name: "Pandoh & Kullu", desc: "Scenic transit stop", type: "nature" },
    { lat: 32.3700, lng: 77.2400, name: "Rohtang Pass & Solang", desc: "High snowy pass & glaciers", type: "adventure" },
    { lat: 32.2600, lng: 77.1880, name: "Vashisht Springs", desc: "Sulphur hot springs baths", type: "nature" },
    { lat: 32.2190, lng: 76.3230, name: "Dharamshala", desc: "Spiritual Dalai Lama residence", type: "landmark" },
    { lat: 32.5387, lng: 75.9710, name: "Dalhousie", desc: "Colonial town outer ridge", type: "town" },
    { lat: 32.5540, lng: 76.0620, name: "Khajjiar", desc: "Saucer-meadow and lake", type: "nature" },
    { lat: 28.6139, lng: 77.2090, name: "Delhi Drop", desc: "End of the tour in Delhi", type: "drop" }
  ]
};
...
const PAGE_DETAILS = {
  ...
  itinerary: [
    ...
    },
    {
      ...
      desc: "Morning Checkout from Dalhousie and drive to Delhi. The journey  time is about 12 hours ( 570 kilometers). Dropping at Delhi railway station / bus stand / airport for onward Journey."
    }
  ],
...
export default function ShimlaManaliDharamshalaDalhousie8n9dDelhi() {

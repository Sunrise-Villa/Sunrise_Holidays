...
const destManaliImg = "https://cdn.jsdelivr.net/gh/Sunrise-Villa/Sunrise_Holidays@main/src/assets/Himachal_2.webp";
import RouteMap from '../../../components/RouteMap';

const ROUTE_MAP_DATA = {
  title: "Shimla-Manali 6N/7D from Delhi",
  stops: [
    ...
    { lat: 31.0780, lng: 77.1130, name: "Tara Devi Temple", desc: "Hilltop temple panorama.", type: "temple" },
    { lat: 31.0830, lng: 77.1350, name: "Sankat Mochan Temple", desc: "Revered Hanuman temple near Shimla.", type: "temple" },
    { lat: 31.1048, lng: 77.1734, name: "The Ridge & Mall Road", desc: "Heritage promenade walk.", type: "market" },
    ...
    { lat: 31.7089, lng: 76.9320, name: "Mandi", desc: "En route via Pandoh Dam.", type: "town" },
    { lat: 31.9579, lng: 77.1095, name: "Kullu", desc: "Beas river and shawl market.", type: "market" },
    { lat: 32.2432, lng: 77.1543, name: "Hadimba Devi Temple", desc: "450-year-old cedarwood temple.", type: "temple" },
    { lat: 32.2611, lng: 77.1810, name: "Vashisht Hot Springs", desc: "Sulphur baths village.", type: "springs" },
    { lat: 32.3722, lng: 77.2466, name: "Rohtang Pass", desc: "3978m snow glaciers.", type: "mountain" },
    { lat: 32.3154, lng: 77.1546, name: "Solang Valley", desc: "Paragliding and Rahalla falls.", type: "adventure" },
  ...
  itinerary: [
    {
      ...
      desc: "Pickup from Delhi Airport / Railway Station / Bus Stand by exclusive vehicle. Drive to Shimla (370 km, 7:30-8:00 hours) via Kurukshetra, Ambala, Kalka, Parwanoo, Barog and Solan. Check in and overnight stay in Hotel."
    },
    {
      day: 2,
      title: "Shimla Local Sightseeing",
      desc: "After Breakfast, visit Tara Devi Temple, Sankat Mochan Temple, Indian Institute of Advanced Studies (IIAS), Army Museum, Jakhoo Temple. Evening walk at Ridge, Mall road Scandal Point, Kali Bari. Overnight stay in Shimla."
    },
    {
      day: 3,
    ...
    },
    {
      ...
      desc: "Morning proceed to Visit the 450 years old Hadimba Devi Temple built in the tranquil and serene woods, Tibetan center & monastery, Club House, Vanvihar, Mall Road Manali and Vashisht village hot springs. Night stay in Manali."
    },
    {
      day: 6,
...
export default function ShimlaManali6N7DDelhi() {
